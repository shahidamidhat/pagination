...
//creating buttons for page numbers
...
//printing data
function printdata(k,data){
  var tb=document.getElementById("table-body");
  tb.innerHTML="";

  for(let i=(k-1)*10;i<k*10;i++){
...
//this is to store the id of current page which is open in the window
function getIdClicked(clickedId){
   document.getElementById("currentId").innerHTML=clickedId;
}
//previous button function
function previousPage(){    
    var current=parseInt(document.getElementById("currentId").innerText);
    document.getElementById(current-1).click();
    document.getElementById("currentId").innerHTML=current-1;
...
//disabling prev and next button when page 1st and page last was open.
if((parseInt(document.getElementById("currentId").innerText))==1){
  document.getElementById("previous").disabled=true;
}
if((parseInt(document.getElementById("currentId").innerText))==10){
